...
class MUDClient:
    def __init__(self, host='localhost', port=4000, data_dir='data'):
        self.host = host
        self.port = port
        self.sock = None
    ...
    def load_state(self, filename):
        """Loads state from a JSON file in the data directory."""
    ...
    def save_state(self, filename, data):
        """Saves state to a JSON file in the data directory."""
        filepath = os.path.join(self.data_dir, filename)
    ...
    def connect(self, username, password):
        ...
        time.sleep(1) # Add a small delay to let the initial banner pass
